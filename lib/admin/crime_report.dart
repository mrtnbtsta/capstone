...
class DashboardCrime extends StatefulWidget {
  const DashboardCrime({super.key});

  @override
  DashboardCrimeState createState() => DashboardCrimeState();
}

class DashboardCrimeState extends State<DashboardCrime> {
  ...
  @override
  void initState() {
    emergencyController.fetchCrime();
    ...
    return GetX<EmergencyController>(
      builder: (controller) {
        return ListView.builder(
          itemCount: controller.crimeModel.length,
          physics: const ScrollPhysics(),
          shrinkWrap: true,
          itemBuilder: (context, index) {
            final data = controller.crimeModel[index];
            return Column(
              children: [
                Row(
                              ...
                              child: IconButton(
                                  onPressed: () async {
                                    ...
                                    if (response.isTapConfirmButton) {
                                      ...
                                      emergencyController
                                          .deleteCrimeReportData(data.rid);
                                      // setState(() {
