...
import 'package:capstone_project/admin/lost_found_searched.dart';
...
class _DashboardLostFoundState extends State<DashboardLostFound> {
  ...
  List<LostFoundModel1> items = <LostFoundModel1>[];

  @override
  void initState() {
    displayLostFoundData();
    filterLostFoundData().then((value) {
      setState(() {
        items.addAll(value);
      });
    });
  ...
  Future<List<LostFoundModel1>> fetchSuggestions(String search) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: EasySearchBar(
          ...
          searchHintText: "Search lost found...",
          onSearch: (p0) {
            setState(() {
              searchItem = p0;
            });
          ...
          onSuggestionTap: (data) {
            Navigator.of(context).push(PageRouteBuilder(
                pageBuilder: (context, animation, secondaryAnimation) =>
                    DashboardLostFoundSearch(lostItem: data),
