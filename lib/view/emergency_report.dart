...
class EmergencyReport extends StatefulWidget {
  ...
  @override
  EmergencyReportState createState() => EmergencyReportState();
}

class EmergencyReportState extends State<EmergencyReport> {
  int selectedValue = 0;
    ...
    return Scaffold(
            ...
            child: Column(
              children: <Widget>[
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: reportIndex == 0
                                ? const Color.fromARGB(255, 102, 80, 211)
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Navigator.of(context).pushNamed(RouteName.hazard);
                        },
                        child: Container(
                          margin: const EdgeInsets.only(left: 5, right: 5),
                          padding: const EdgeInsets.only(top: 20, bottom: 20),
                ...
                Container(
                  ...
                  child: const Text("EMERGENCY REPORTS",
                      style: TextStyle(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Checkbox(
                              ...
                              onChanged: (value) => setState(() {
                                selectedValue = 6;
                                emergency = "Civil Disorder";
                                // print(emergency);
                              }),
                            ),
                          ),
                          const Expanded(
                            child: Text("Civil Disorder",
                                style: TextStyle(
                                    color: Color.fromRGBO(26, 23, 44, 1),
                                    letterSpacing: 0.5,
                                    wordSpacing: 0.5,
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: const Icon(EvaIcons.alert_triangle,
              color: Color.fromRGBO(252, 69, 69, 1)),
        ),
